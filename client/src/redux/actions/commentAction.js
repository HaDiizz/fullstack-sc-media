...
export const updateComment =
  ...
  async (dispatch) => {
    try {
      const updateComment = EditData(post.comments, comment._id, {
        ...comment,
        content,
      });
      const updatePost = { ...post, comments: updateComment };

      dispatch({ type: POST_TYPES.UPDATE_POST, payload: updatePost });
